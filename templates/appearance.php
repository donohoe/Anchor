...
<div class="anchor-page anchor-appearance">
		...
		<div class="anchor-account-layout">
			<aside class="anchor-account-sidebar">
				...
				<nav class="anchor-account-nav">
					...
					<a href="<?php echo esc_url( \Anchor\Router::get_appearance_url() ); ?>" class="active">
			...
			<main class="anchor-account-main">
				<h1><?php esc_html_e( 'Appearance', 'anchor' ); ?></h1>
				<p class="anchor-page-description"><?php esc_html_e( 'Customize how the site looks for you.', 'anchor' ); ?></p>

				<div class="anchor-stub">
					<p><?php esc_html_e( 'Dark mode and language preferences will appear here.', 'anchor' ); ?></p>
				</div>

				<?php do_action( 'anchor_appearance_page_content', $member ); ?>
			</main>
		</div>
	</div>
</div>
